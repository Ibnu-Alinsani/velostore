...
<template>
  <div class="relative bg-gradient-to-b from-zinc-900 to-zinc-950 border-b border-white/5 overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
      <!-- Breadcrumb -->
      <div v-if="breadcrumbs.length > 0" class="flex items-center gap-2 text-sm text-zinc-500 mb-6 lg:mb-8">
        <template v-for="(crumb, index) in breadcrumbs" :key="index">
          ...
          <svg v-if="index < breadcrumbs.length - 1" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
